...
class GridWSIPatchDataset(Dataset):
    ...
    def _preprocess(self):
        ...
        print("level_1:", self._slide.level_dimensions[self._level])
        downsample = int(self._slide.level_downsamples[0] / self._slide.level_downsamples[self._level])
    ...
    def __getitem__(self, idx):
        ...
        downsample = int(self._slide.level_downsamples[0]/self._slide.level_downsamples[self._level])
        x = int(x_center - self._image_size * downsample / 2)
        y = int(y_center - self._image_size * downsample / 2)
